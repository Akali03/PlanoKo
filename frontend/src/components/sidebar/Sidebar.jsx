import { LayoutGrid, Circle, CheckCircle2, Star } from "lucide-react";

function Sidebar({ tasks = [], activeView, onViewChange }) {
    ...
    return (
        <aside className="w-64 h-screen bg-[#0b0b12] text-slate-200 flex flex-col px-4 py-6">
            <div className="mb-8">
                <p className="text-xs font-semibold tracking-wider text-slate-500 mb-3 px-2">
                    VIEWS
                </p>
